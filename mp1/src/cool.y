...
%type <formal> formal
%type <expressions> expression_list expression_list2
%type <expression> expression let assign
%type <cases> case_list

/* Precedence declarations go here. */
/* We add IN here to fix let conflict */
%right IN
%right ASSIGN
%right NOT
%nonassoc LE '<' '='
...
/* Handle list of features, use empty to avoid conflicts, take care of method and attr */
...
/* Handle let and assign in let */
let: OBJECTID ':' TYPEID assign IN expression
{ $$ = let($1, $3, $4, $6);}
...
/* Two different kinds of expression, the second one is for block */
...
/* Handle different kinds of dispatch */
        | expression '.' OBJECTID '(' ')'
