...
class op_type {
	...
	public:
       ...
       string get_ptr_type_name() const { return name + "*"; }
		...
		//op_type get_result_type() {return op_type(NULL);}
		//vector<op_type> get_arg_types() {return vector<op_type>;}
		//op_type get_result_type();
		//vector<op_type> get_arg_types();
...
class op_func_type : public op_type {
	...
	public:
		...
		op_type get_result_type() {return res;}
